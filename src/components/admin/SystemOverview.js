        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-gray-900 dark:text-white font-medium">
                {metrics.system?.uptimeFormatted || metrics.system?.uptime}
              </span>
            </div>
          </div>
          <div>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span
                  className={`font-medium ${metrics.polling_scheduler.isRunning ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                >
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-gray-900 dark:text-white font-medium">
                  {metrics.polling_scheduler.activePollers || 0}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-gray-900 dark:text-white font-medium">
                {metrics.databases?.master_size_formatted || 'N/A'}
              </span>
            </div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-gray-900 dark:text-white font-medium">
                {metrics.databases?.total_user_size_formatted || '0 MB'}
              </span>
            </div>
          </div>
        </div>
