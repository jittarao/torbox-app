...
export default function SearchBarDropdowns({
  ...
  if (!showHistory && !showSuggestions && !showTitleSection) return null;

  return (
    <div className="absolute left-0 right-0 z-50 mt-1 max-h-96 overflow-y-auto rounded-md border border-border bg-white shadow-lg dark:border-border-dark dark:bg-[#1a1a1d]">
