...
export default function AdminLayout({ children }) {
  ...
  return (
    <div
      className="min-h-dvh bg-surface text-text dark:bg-surface-dark dark:text-text-dark"
      style={{ '--admin-sidebar-width': ADMIN_SIDEBAR_WIDTH }}
    >
      <AdminSidebar locale={locale} />
      <div className="flex min-h-dvh min-w-0 flex-col pl-0 transition-[padding-left] duration-300 md:pl-[var(--admin-sidebar-width)]">
