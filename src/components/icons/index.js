...
import VerticalEllipsisIcon from './VerticalEllipsis';
...
import ArrowLeftRightIcon from './ArrowLeftRight';
import ClockArrowDownIcon from './ClockArrowDown';
...
import TorrentIcon from './Torrent';
import UsenetIcon from './Usenet';
import WebdlIcon from './Webdl';
import HistoryIcon from './History';
import MoonIcon from './Moon';
import SunIcon from './Sun';
import PlusIcon from './Plus';
import PreferencesIcon from './Preferences';
...
import QuestionMarkCircleIcon from './QuestionMarkCircle';
...
import BarChart3Icon from './BarChart3';
import CreditCardIcon from './CreditCard';
import ReceiptIcon from './Receipt';
import HardDriveIcon from './HardDrive';
...
import GoFileIcon from './GoFile';
import FichierIcon from './Fichier';
import PixeldrainIcon from './Pixeldrain';
import XIcon from './X';
import ExpandAllIcon from './ExpandAll';
