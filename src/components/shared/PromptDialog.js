    ...
    <ModalSheet open={open} onClose={onCancel} closeLabel={cancelLabel} aria-labelledby={titleId}>
      <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col p-4 sm:p-6">
        ...
        <input
          ...
          className={`w-full rounded-xl border border-border/80 bg-surface px-3 py-2 text-sm text-primary-text focus:border-accent/50 focus:outline-hidden focus:ring-2 focus:ring-accent/15 dark:border-border-dark/80 dark:bg-surface-dark dark:text-primary-text-dark dark:focus:ring-accent-dark/15 ${
