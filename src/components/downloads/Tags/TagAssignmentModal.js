...
function TagAssignmentModalBody({ downloadIds = EMPTY_ARRAY, apiKey, onClose, onSuccess }) {
  const t = useTranslations('DownloadsFilters');
  ...
  }, [downloadIds, downloadCount, getDownloadTags, tagMappings]);
