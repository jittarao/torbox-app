...
const VARIANT_CLASS = {
  primary:
    'bg-accent text-white border border-accent/30 hover:bg-accent/90 dark:bg-accent-dark dark:border-accent-dark/40 dark:hover:bg-accent-dark/90',
  secondary:
  ...
  danger:
    'bg-label-danger-text text-white border border-label-danger-text/30 hover:brightness-95 dark:bg-label-danger-text-dark dark:border-label-danger-text-dark/30 dark:hover:brightness-110',
  ghost:
...
/**
 * Compact bulk-action control with icon + short label.
 */
